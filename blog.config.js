...
const BLOG = {
  AUTHOR: 'Logic', // 作者
  BIO: '给时光以生命，给岁月以文明', // 作者简介
  LINK: 'https://angel0726.github.io/', // 网站地址
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'Angel0726/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHNF9og', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHNF9os4COsgV', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '8326cbae-e3d2-4a99-9bca-eb8ad141ca0b', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Hari Seldon BLOG', // 站点标题 ，被notion中的页面标题覆盖
