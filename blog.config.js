...
const BLOG = {
  AUTHOR: 'angel', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://coolnext.vercel.app/', // 网站地址
  AVATAR: '/avatar.png', // 个人头像 默认取public目录下的avatar.png
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '52fe045a5b7c46308a5a8bed9a192582?v=fbe6fd48403f428890b7d87a32355678', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
